...
restartBtn.addEventListener('click', () => { results.classList.add('hidden'); startTest(); });
document.getElementById('try-again').addEventListener('click', () => { results.classList.add('hidden'); startTest(); });
